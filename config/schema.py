...
class RLConfig:
    ...
    vllm_actor_cuda_visible_devices: List[str] = field(default_factory=list)
    vllm_rollout_actors: List[Dict[str, Any]] = field(default_factory=list)
    vllm_actor_start_method: str = "spawn"
    vllm_actor_request_timeout_sec: float = 600.0
    vllm_actor_shutdown_timeout_sec: float = 30.0
    vllm_actor_resource_log_every: int = 1
